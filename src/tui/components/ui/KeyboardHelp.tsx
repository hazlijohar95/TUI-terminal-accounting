...
export const invoiceShortcuts: KeyboardShortcut[] = [
  ...
  { key: "e", description: "E-Invoice panel", category: "Invoice Actions" },
  { key: "m", description: "Email invoice", category: "Invoice Actions" },
  { key: "f", description: "Cycle date filter", category: "Filtering" },
